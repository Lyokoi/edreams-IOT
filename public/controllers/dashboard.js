angular.module('MyApp')
  .controller('DashboardCtrl', ['$scope', '$alert', '$http','liveService', function($scope, $alert, $http, liveService) {
...
//        liveService.onChangeData($scope, function (message) {
//            $scope.records = message.filterData;
//        });

        liveService.onConfirmData($scope, function (message) {
            $scope.records = message.confirmedData;
        });
